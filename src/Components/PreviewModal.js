...
const PreviewModal = (props) => {
    ...
    return (
        <div tabindex="-1" className={`${showPreview ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full backdrop-opacity-40 backdrop-invert`}>
            <div className="relative p-4 w-full h-full md:h-auto">
                ...
                <div className="relative bg-white rounded shadow-md dark:bg-gray-700">
                    ...
                    <div className="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                        ...
                        <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => setPreviewModalVisibility(false)}>
