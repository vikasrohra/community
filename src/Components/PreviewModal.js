...
const PreviewModal = (props) => {
    ...
    return (
        <div className={`${showPreview ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-40 w-full md:inset-0 h-full md:h-full backdrop-opacity-40 backdrop-invert`}>
            <div className="relative p-4 w-full h-full md:h-[100vh]">
                {/* <!-- Modal content --> */}
