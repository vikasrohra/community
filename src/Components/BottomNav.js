...
const BottomNav = (props) => {
    const { animate, isHomeSelected, isGroupsSelected, isSettingsSelected, setHomeVisibility, setGroupsVisibility, setSettingsVisibility } = { ...props };
    ...
    return (
        <div className="fixed bottom-0 border-t border-t-gray-200 dark:border-t-gray-700 w-full lg:hidden shadow-md">
            <Navbar
                fluid={false}
                rounded={false}
                border={false}
