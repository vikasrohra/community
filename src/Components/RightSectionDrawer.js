...
const RightSectionDrawer = (props) => {
    ...
    return (
        <>
            {showRightSectionDrawer && <div className="lg:hidden cursor-pointer fixed top-4 left-4 z-50">
            ...
            <div className={`lg:hidden md:w-[50vw] w-[90vw] h-screen fixed top-0 left-0 z-40 top-0 p-4 overflow-y-auto bg-white dark:bg-gray-800 ${showRightSectionDrawer ? '-translate-x-0' : '-translate-x-full'} ease-in-out duration-500 opacity-100`}>
                <div className="mt-12">
                    <CommunityOwner />
                    <TopContributors />
                </div>
