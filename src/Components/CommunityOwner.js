        ...
        <>
            ...
            <div className="w-full bg-white border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div className="flex flex-col items-center py-5 px-5">
                    ...
                    {animate ? <svg className="w-24 h-24 text-gray-200 dark:text-gray-700 animate-pulse" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd"></path></svg> : <img className="mb-3 w-24 h-24 ring-2 ring-gray-300 rounded-full shadow-lg" src={require('../Assets/Images/owner.png')} alt="Bonnie" />}
